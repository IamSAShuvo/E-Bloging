...
import eblog.service.impl.PostDecoratorImpl;
...
public class PostController {
	...
	@GetMapping("/posts/searchByBlogger/{keywords}")
	public ResponseEntity<List<PostDto>> getPostByBlogger(@PathVariable String keywords) {
		List<PostDto> searchPosts = new PostDecoratorImpl(service).searchPosts(keywords);
